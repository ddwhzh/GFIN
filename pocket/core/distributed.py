...
class DistributedLearningEngine(State):
    ...
    def __init__(self,
            ...
            verbal: bool = True, print_interval: int = 10, use_amp: bool = True,
        ...
        self._criterion = criterion if not isinstance(criterion, torch.nn.Module) or self._device.type=="cpu" \
            else criterion.cuda()
