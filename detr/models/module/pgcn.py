...
class PGCN(torch.nn.Module):
    def __init__(self, model_configs, graph_configs, hidden_dim=512, test_mode=False):
        ...
        self._prepare_pgcn()
        self.Act_GCN = GCN(self.act_feat_dim, hidden_dim, self.act_feat_dim, dropout=model_configs['gcn_dropout'])
        self.Comp_GCN = GCN(self.comp_feat_dim, hidden_dim, self.comp_feat_dim, dropout=model_configs['gcn_dropout'])
